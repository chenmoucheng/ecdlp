 ...
 * I0 := Ideal([e1,e2,d1,d2,s1,s2,c0]); J0 := EliminationIdeal(I0,{T1,T2,C,D,C0}); G0 := Coefficients(Basis(J0)[1],C0);
 * I1 := Ideal([e1,e2,d1,d2,s1,s2,c1]); J1 := EliminationIdeal(I1,{T1,T2,C,D,C1}); G1 := Coefficients(Basis(J1)[1],C1);
 * 
